...
ListItem *SelectionSort(ListItem* list)
{
    // Simply implement the pseudocode from the lab manual for a selection
    // sort
...
ListItem *InsertionSort(ListItem* list)
{
    // once again,implement the pseudocode for a insertion sort from
    // lab doc
